#ifndef MVP2_MISSION__NODE_
#define MVP2_MISSION__NODE_
...
/**
 * @class mvp2_mission::NodeWrapper
 * @brief A rclcpp node wrapper to enable common mvp2_mission needs such as manipulating parameters
 */
...
public:
   ...
   */
  std::shared_ptr<mvp2_mission::NodeWrapper> shared_from_this()
  {
    return std::static_pointer_cast<mvp2_mission::NodeWrapper>(
