...
#ifndef MVP2_UTIL__LIFECYCLE_NODE_
#define MVP2_UTIL__LIFECYCLE_NODE_
...
public:
   ...
   */
  std::shared_ptr<mvp2_util::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<mvp2_util::LifecycleNode>(
   ...
   */
  mvp2_util::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
...
#endif  // MVP2_UTIL__LIFECYCLE_NODE_
